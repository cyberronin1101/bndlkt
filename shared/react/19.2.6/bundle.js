...
window.bndlkt.register('react@19.2.6', function (e, t, n) {
	(function (e, t, n) {
		(() => {
			'use strict';
			var e = {
					773(e, t) {
						...
						((E.constructor = S), _(E, b.prototype), (E.isPureReactComponent = !0));
						var w = Array.isArray;
						function g() {}
						...
						function x(e, t, o, u, i) {
									...
									case 'object':
										switch (e.$$typeof) {
											...
											case r:
												...
												break;
											case p:
												return x((f = e._init)(e._payload), t, o, u, i);
										}
								}
							if (f)
								return (
							...
							var l,
								y = '' === u ? '.' : u + ':';
							if (w(e))
								for (var h = 0; h < e.length; h++) f += x((u = e[h]), t, o, (c = y + $(u, h)), i);
							else if (
								'function' ==
								typeof (h =
								...
								for (e = h.call(e), h = 0; !(u = e.next()).done; )
									f += x((u = u.value), t, o, (c = y + $(u, h++)), i);
							else if ('object' === c) {
