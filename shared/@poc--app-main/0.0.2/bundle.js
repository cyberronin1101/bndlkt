...
window.bndlkt.register('@poc/app-main@0.0.2', function (n, e, t) {
	(function (n, e, t) {
		(() => {
			var e,
				r,
				...
				i = {
					...
					671(n, e, t) {
						...
						n.exports = function (n, e, t) {
							...
							function v(n) {
								var t = n - f;
								return void 0 === f || t >= e || t < 0 || (x && n - m >= d);
							}
							function y() {
								var n = a();
								if (v(n)) return j(n);
								u = setTimeout(
									...
									(function (n) {
										var t = e - (n - f);
										return x ? s(t, d - (n - m)) : t;
									})(n),
								);
							}
							function j(n) {
								return ((u = void 0), b && c ? g(n) : ((c = l = void 0), p));
							}
							function k() {
								var n = a(),
									t = v(n);
								if (((c = arguments), (l = this), (f = n), t)) {
									if (void 0 === u)
										return (function (n) {
											return ((m = n), (u = setTimeout(y, e)), h ? g(n) : p);
										})(f);
									if (x) return (clearTimeout(u), (u = setTimeout(y, e)), g(f));
								}
					...
					810(n, e) {
						...
						function r(n, e, r) {
							...
							return (
								(e = r.ref),
								{ $$typeof: t, type: n, key: a, ref: void 0 !== e ? e : null, props: r }
							);
						}
					...
					34(n) {
						...
						n.exports = new Promise(function (n, e) {
							...
							window.bndlkt.requireLazy('@poc/app-main@0.0.2', '@poc/app-header').then(n).catch(e);
						});
					},
				},
				s = {};
					...
					if (a[n]) a[n].push(e);
						...
						if (void 0 !== t)
							for (var l = document.getElementsByTagName('script'), d = 0; d < l.length; d++) {
								var p = l[d];
								if (p.getAttribute('src') == n || p.getAttribute('data-webpack') == o + t) {
									i = p;
									break;
								}
							}
			...
			(() => {
				'use strict';
				(c.r(l), c.d(l, { Dashboard: () => N, LazyAppHeader: () => k }));
				var e = c(80),
					t = c(671),
					r = c.n(t);
				const a = n('react'),
					o = n('react-dom/client');
				var i = c(599),
					s = c.n(i),
					d = c(644),
					p = c.n(d),
				...
				const k = (0, a.lazy)(() =>
					...
					N = () => {
						...
						return (0, e.jsxs)('div', {
							className: 'dashboard',
							children: [
								(0, e.jsx)('div', { className: 'app-version', children: 'app-main v0.0.2' }),
								(0, e.jsxs)('div', {
								...
								(0, e.jsxs)('div', {
									...
									children: [
										(0, e.jsx)('h3', { children: 'Why bndlkt?' }),
										(0, e.jsxs)('div', {
											...
											children: [
												(0, e.jsxs)('div', {
													...
													children: [
														(0, e.jsx)('h4', { children: '⚡ Parallel Loading' }),
														(0, e.jsxs)('p', {
															children: [
																'The bundle and all its dependencies are fetched simultaneously with ',
																(0, e.jsx)('code', { children: 'Promise.all' }),
												...
												(0, e.jsxs)('div', {
													className: 'feature-card',
													children: [
														(0, e.jsx)('h4', { children: '🔄 Scope Switching' }),
														(0, e.jsx)('p', {
															children:
																'Switch environments (release, pre-release, develop) on the fly without rebuilding a single bundle.',
														}),
													],
												}),
												(0, e.jsxs)('div', {
													className: 'feature-card',
													children: [
														(0, e.jsx)('h4', { children: '🧩 Centralized Versioning' }),
														(0, e.jsx)('p', {
															children:
																'The backend constructs a version graph per scope, guaranteeing a single consistent version of each dependency with no duplication.',
														}),
													],
												}),
												(0, e.jsxs)('div', {
													className: 'feature-card',
													children: [
														(0, e.jsx)('h4', { children: '📋 Declarative Contract' }),
														(0, e.jsxs)('p', {
															children: [
																'All environment variables and external dependencies are declared in ',
																(0, e.jsx)('code', { children: 'package.json' }),
																' – no extra config files or runtime parsing.',
															],
														}),
													],
												}),
				...
				null !== S &&
					(0, o.createRoot)(S).render((0, e.jsx)(a.StrictMode, { children: (0, e.jsx)(N, {}) }));
			})();
			var d = t;
